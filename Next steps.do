...
*1.d
{
reg ln_n_speed_s i.alloc_off##i.hard i.week i.wave , cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t4.tex", replace  noni addtext(section+Week+Wave FE, Yes) auto(3) ctitle(All waves)

reg ln_n_speed_s i.alloc_off##i.hard alloc_off i.week  if wave==5 , cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t4.tex", append  noni addtext(section+Week+Wave FE, Yes) auto(3) ctitle(Wave 3.5)

reg ln_n_speed_s i.alloc_off##i.hard alloc_off i.week  if wave==6 , cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t4.tex", append  noni addtext(section+Week+Wave FE, Yes) auto(3) ctitle(Wave 4)

reg ln_n_speed_s i.alloc_off##i.hard alloc_off i.week i.wave if wave>4 , cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t4.tex", append  noni addtext(section+Week+Wave FE, Yes) auto(3) ctitle(Wave 3.5 \& 4)

reg ln_n_speed_s i.alloc_off##i.hard i.week i.wave ln_n_speed_cash, cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t4.tex", append  noni addtext(section+Week+Wave FE, Yes) auto(3) ctitle(All waves)

reg ln_n_speed_s i.alloc_off##i.hard alloc_off i.week ln_n_speed_cash if wave==5 , cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t4.tex", append  noni addtext(section+Week+Wave FE, Yes) auto(3) ctitle(Wave 3.5)

reg ln_n_speed_s i.alloc_off##i.hard alloc_off i.week ln_n_speed_cash if wave==6, cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t4.tex", append  noni addtext(section+Week+Wave FE, Yes) auto(3) ctitle(Wave 4)

reg ln_n_speed_s i.alloc_off##i.hard alloc_off i.week i.wave ln_n_speed_cash if wave>4 , cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t4.tex", append  noni addtext(section+Week+Wave FE, Yes) auto(3) ctitle(Wave 3.5 \& 4)
}
...
foreach x of varlist ln_avg16_n_speed_s ln_n_speed_cash ln_n_speed_plain  ln_speed_60min{

reg `x'  pref_office ad_office alloc_off if user_n==1 & ad_type!="", cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t21$i.tex", replace  noni  auto(3) ctitle(All waves)

reg `x'  pref_office ad_office alloc_off if wave==5 & user_n==1 & ad_type!="", cluster(person_week)
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t21$i.tex", append  noni  auto(3) ctitle(Wave 3.5)

reg `x'  pref_office ad_office alloc_off if wave==6 & user_n==1 & ad_type!="", cluster(person_week)
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t21$i.tex", append  noni  auto(3) ctitle(Wave 4)

reg `x'  pref_office ad_office alloc_off if wave>4 & user_n==1 & ad_type!="", cluster(person_week)
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t21$i.tex", append  noni  auto(3) ctitle(Wave 3.5 \& 4)

global i= $i + 1
}

*Selection across all waves

reg ln_avg16_n_speed_s  pref_office alloc_off i.wave if user_n==1, cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t219.tex", replace  noni auto(3) ctitle(All waves)

reg ln_avg16_n_speed_s  pref_office alloc_off i.wave ad_office if user_n==1 & wave>1, cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t219.tex", append  noni auto(3) ctitle(Waves>1)

reg ln_avg16_n_speed_s  pref_office alloc_off i.wave if user_n==1 & wave==1, cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t219.tex", append  noni auto(3) ctitle(Wave 1)

reg ln_avg16_n_speed_s  pref_office alloc_off ad_office if user_n==1 & wave==2 & ad_type!="", cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t219.tex", append  noni auto(3) ctitle(Wave 2)

reg ln_avg16_n_speed_s  pref_office alloc_off ad_office if user_n==1 & wave==3 & ad_type!="", cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t219.tex", append  noni auto(3) ctitle(Wave 3)

reg ln_avg16_n_speed_s  pref_office alloc_off ad_office if user_n==1 & wave==5 & ad_type!="", cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t219.tex", append  noni auto(3) ctitle(Wave 3.5)

reg ln_avg16_n_speed_s  pref_office alloc_off ad_office if user_n==1 & wave==6 & ad_type!="", cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t219.tex", append  noni auto(3) ctitle(Wave 4)


*2.b.1
{
reg ln_avg16_n_speed_s i.pref_office##i.ad_office  if user_n==1 & ad_type!="", cluster( person_week )
...
reg ln_avg16_n_speed_s i.pref_office##i.ad_office alloc_off if user_n==1 & ad_type!="", cluster( person_week )
...
reg ln_avg16_n_speed_s i.pref_office##i.ad_office if wave==5 & user_n==1 & ad_type!="", cluster(person_week)
...
reg ln_avg16_n_speed_s i.pref_office##i.ad_office alloc_off if wave==5 & user_n==1 & ad_type!="", cluster(person_week)
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t211.tex", append  noni addtext(Week and Wave FE, Yes) auto(3) ctitle(Wave 3.5)

reg ln_avg16_n_speed_s i.pref_office##i.ad_office if wave==6 & user_n==1 & ad_type!="", cluster(person_week)
...
reg ln_avg16_n_speed_s i.pref_office##i.ad_office alloc_off if wave==6 & user_n==1 & ad_type!="", cluster(person_week)
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t211.tex", append  noni addtext(Week and Wave FE, Yes) auto(3) ctitle(Wave 4)

reg ln_avg16_n_speed_s i.pref_office##i.ad_office if wave>4 & user_n==1 & ad_type!="", cluster(person_week)
...
reg ln_avg16_n_speed_s i.pref_office##i.ad_office alloc_off if wave>4 & user_n==1 & ad_type!="", cluster(person_week)
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t211.tex", append  noni addtext(Week and Wave FE, Yes) auto(3) ctitle(Wave 3.5 \& 4)
}
...
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t2121.tex", replace  noni addtext(Week and Wave FE, Yes) auto(3) ctitle(All waves)

reg ln_avg16_n_speed_s pref_office alloc_off if user_n==1 & ad_office==1, cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t2121.tex", append  noni addtext(Week and Wave FE, Yes) auto(3) ctitle(All waves)

reg ln_avg16_n_speed_s pref_office if wave==5 & user_n==1 & ad_office==1, cluster(person_week)
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t2121.tex", append  noni addtext(Week and Wave FE, Yes) auto(3) ctitle(Wave 4)
...
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t2121.tex", append  noni addtext(Week and Wave FE, Yes) auto(3) ctitle(Wave 3)
...
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t2121.tex", append  noni addtext(Week and Wave FE, Yes) auto(3) ctitle(Wave 3 \& 4)
...
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t2122.tex", replace  noni addtext(Week and Wave FE, Yes) auto(3) ctitle(All waves)

reg ln_avg16_n_speed_s pref_office alloc_off if user_n==1 & ad_office==0, cluster( person_week )
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t2122.tex", append  noni addtext(Week and Wave FE, Yes) auto(3) ctitle(All waves)

reg ln_avg16_n_speed_s pref_office if wave==5 & user_n==1 & ad_office==0, cluster(person_week)
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t2122.tex", append  noni addtext(Week and Wave FE, Yes) auto(3) ctitle(Wave 4)
...
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t2122.tex", append  noni addtext(Week and Wave FE, Yes) auto(3) ctitle(Wave 3)
...
outreg2 using "C:\Users\sumit\Documents\Work\Worker Sorting\My work\tex files\regressions\t2122.tex", append  noni addtext(Week and Wave FE, Yes) auto(3) ctitle(Wave 3 \& 4)
